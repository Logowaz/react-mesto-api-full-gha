...
function Card({card, onCardClick, onCardLike, onCardDelete, onConfirmDelete}) {
    ...
    // console.log(card);
    // console.log(Array.isArray(card.likes));
    const isLiked = Array.isArray(card.likes) && card.likes.some(i => i === currentUser._id);
    // console.log(card);
        ...
        <article className="elements__element">
            ...
            <div className="elements__caption">
                ...
                <div className="elements__like-place">
                    ...
                    <p className="elements__like-counter">{card.likes ? card.likes.length : 0}</p>
                </div>
            </div>
